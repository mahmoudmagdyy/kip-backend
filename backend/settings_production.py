...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-2k3(7sf0_ehy*%z4%$t4&pdeq2ozu2+*nfg4fimh2bnl)ky1rf')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

ALLOWED_HOSTS = [
    'kip-backend.onrender.com',
    'localhost',
    '127.0.0.1',
    '72.60.209.172',  # Your server IP
    'www.72.60.209.172',  # Your server IP with www
...
# JWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=30),  # 30 days for production
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),  # 30 days for production
...
SERVER_DOMAIN = 'kip-backend.onrender.com'
