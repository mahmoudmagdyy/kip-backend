...
async def test_mobile_websocket_debug():
    print("🚀 Mobile WebSocket Debug Test")
    print("=============================")
    ...
    try:
        ...
        async with websockets.connect(WEBSOCKET_URL) as websocket:
            ...
            now = datetime.now()
            booking_date = (now + timedelta(days=9)).strftime('%b %d, %Y') # Mobile app format
            booking_time = "11:00 PM" # Mobile app format
            
            booking_data = {
                "service_name": "Mobile Debug Test Service",
                "booking_date": booking_date,
                "booking_time": booking_time,
                "notes": "Mobile WebSocket debug test"
            }
            ...
            if response.status_code in [200, 201]:
                ...
                try:
                    notification = await asyncio.wait_for(websocket.recv(), timeout=30.0) # Increased timeout
                    ...
                    print("❌ TIMEOUT: No WebSocket notification received within 30 seconds")
...
if __name__ == "__main__":
    asyncio.run(test_mobile_websocket_debug())
