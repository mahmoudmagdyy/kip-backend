...
async def test_websocket_debug():
    ...
    try:
        ...
        async with websockets.connect(WEBSOCKET_URL) as websocket:
            ...
            now = datetime.now()
            booking_date = (now + timedelta(days=6)).strftime('%b %d, %Y') # Mobile app format
            booking_time = "08:00 PM" # Mobile app format
            
            booking_data = {
                "service_name": "Debug WebSocket Test Service",
                "booking_date": booking_date,
                "booking_time": booking_time,
                "notes": "Debug WebSocket notification test from mobile app"
            }
            ...
            if response.status_code in [200, 201]:
                ...
                try:
                    notification = await asyncio.wait_for(websocket.recv(), timeout=15.0) # Increased timeout
                    ...
                    print("❌ TIMEOUT: No WebSocket notification received within 15 seconds")
