...
class UserServiceCreationExample extends StatefulWidget {
  @override
  _UserServiceCreationExampleState createState() => _UserServiceCreationExampleState();
}

class _UserServiceCreationExampleState extends State<UserServiceCreationExample> {
  ...
  static const String CREATE_SERVICE_ENDPOINT = '$BASE_URL/user/services/create/';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Create Service (User)'),
  ...
  Future<void> _createService() async {
    ...
    try {
      ...
      var imageFile = await http.MultipartFile.fromPath(
        'image',
        _selectedImage!.path,
        filename: 'user_service_image_${DateTime.now().millisecondsSinceEpoch}.jpg',
      );
...
void main() {
  runApp(MaterialApp(
    title: 'User Service Creation Example',
    home: UserServiceCreationExample(),
    theme: ThemeData(
