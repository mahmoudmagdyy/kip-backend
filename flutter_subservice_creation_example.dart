...
class SubServiceCreationExample extends StatefulWidget {
  @override
  _SubServiceCreationExampleState createState() => _SubServiceCreationExampleState();
}

class _SubServiceCreationExampleState extends State<SubServiceCreationExample> {
  ...
  static const String CREATE_SUBSERVICE_ENDPOINT = '$BASE_URL/dashboard/sub-services/create/';
  static const String GET_SERVICES_ENDPOINT = '$BASE_URL/dashboard/services/';
  ...
  Future<void> _createSubService() async {
    ...
    try {
      ...
      var imageFile = await http.MultipartFile.fromPath(
        'image',
        _selectedImage!.path,
        filename: 'subservice_image_${DateTime.now().millisecondsSinceEpoch}.jpg',
      );
...
void main() {
  runApp(MaterialApp(
    title: 'Sub-Service Creation Example',
    home: SubServiceCreationExample(),
    theme: ThemeData(
